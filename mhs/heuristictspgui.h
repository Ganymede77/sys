#ifndef HEURISTICTSPMHGUI_H
#define HEURISTICTSPMHGUI_H

#include "commons.h"

//  \brief This class represents a configured MH of the type HEURISTICTSPMH_H.
/*
  This is a subclass of MhSets and represents a configured HEURISTICTSPMH_H.
  It has all the members and configuration variables that a HEURISTICTSPMH_H need
...
class HeuristicTSPMhGUI
{
public:
    HeuristicTSPMhGUI();
    virtual ~HeuristicTSPMhGUI();
    HeuristicTSPMhGUI(const HeuristicTSPMhGUI& other);
    HeuristicTSPMhGUI& operator=(const HeuristicTSPMhGUI& other);
...
private:
    ...
    //QComboBox *cmbBx_decay_function;
    WidgetListInput *dSpnBx_gamma_decrease_intensity;
    ...
    WidgetListInput *spnBx_heupar_number_of_permutations;
...
public:
    ...
    //QComboBox &GetCmbBxDecayFunction() const {return *cmbBx_decay_function;}
    ...
    WidgetListInput &GetSpnbxNumberOfPermutations() const {return *spnBx_heupar_number_of_permutations;}
    WidgetListInput &GetDSpnBxGammaDecreaseIntensity() const {return *dSpnBx_gamma_decrease_intensity;}
    ...
    //void SetCmbBxDecayFunction (QString val) {cmbBx_decay_function->setCurrentText(val);}
    ...
    void SetSpnBxNumberOfPermutations (QVariantList val) {spnBx_heupar_number_of_permutations->SetValues(val);}
    ...
    void SetDSpnBxGammaDecreaseIntensity (QVariantList val) {dSpnBx_gamma_decrease_intensity->SetValues(val);}
