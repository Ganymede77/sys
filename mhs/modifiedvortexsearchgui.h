#ifndef MODIFIEDVORTEXSEARCHGUI_H
#define MODIFIEDVORTEXSEARCHGUI_H

#include "commons.h"

//  \brief This class represents a configured MH of the type Modified Vortex Search.
/*
  This is a subclass of MhSets and represents a configured Modified Vortex Search.
  It has all the members and configuration variables that a Modified Vortex Search need
  to work with a problem.
*/
//MODIFIEDVORTEXSEARCH

class ModifiedVortexSearchGUI
{
public:
    ModifiedVortexSearchGUI();
    virtual ~ModifiedVortexSearchGUI();
    ModifiedVortexSearchGUI(const ModifiedVortexSearchGUI& other);
    ModifiedVortexSearchGUI& operator=(const ModifiedVortexSearchGUI& other);
...
private:
    // ////////////////////////Best Size//////////////////////////////
    /// IN MODIFIED VORTEX SEARCH'S CASE, IT IS THE NUMBER OF VORTICES
...
#endif // MODIFIEDVORTEXSEARCHGUI_H
